...
void MySplit(char csv[10][1024], int num_movies, char titles[10][1024], char years[10][1024], char directors[10][1024], char ratings[10][1024], char dollars[10][1024]);

void copyCharArray(char des[], char src[], int elementSize);
